...
#  Created on Fri Oct 10 14:00:10 2025                
#                                                     
#######################################################
...
globalNetConnect VDD -type pgpin -pin VSS -instanceBasename * -hierarchicalInstance VSS
clearGlobalNets
globalNetConnect VDD -type pgpin -pin VDD -instanceBasename * -hierarchicalInstance {}
globalNetConnect VDD -type pgpin -pin VSS -instanceBasename * -hierarchicalInstance VSS
clearGlobalNets
...
ui_view_box
ui_view_box
dbquery -area {-28.8645 -2.632 90.9045 55.272} -objType inst
dbquery -area {-28.8645 -2.632 90.9045 55.272} -objType regular
dbquery -area {-28.8645 -2.632 90.9045 55.272} -objType special
...
saveNetlist pe64_lookahead_route.v
streamOut pe64_lookahead.enc.dat/priorityt_gds -mapFile fv/pe64_lookahead/fv_map.map.do -libName DesignLib -units 2000 -mode ALL
win off
