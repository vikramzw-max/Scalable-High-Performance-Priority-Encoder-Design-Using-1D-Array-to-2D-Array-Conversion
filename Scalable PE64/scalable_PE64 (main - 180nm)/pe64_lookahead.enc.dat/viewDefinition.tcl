...
create_analysis_view -name wc -constraint_mode constraints -delay_corner max -latency_file ${::IMEX::dataVar}/mmmc/views/wc/latency.sdc
create_analysis_view -name bc -constraint_mode constraints -delay_corner min -latency_file ${::IMEX::dataVar}/mmmc/views/bc/latency.sdc
