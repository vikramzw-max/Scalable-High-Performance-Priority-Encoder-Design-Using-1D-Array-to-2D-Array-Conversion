...
# Generated on: Tue Sep 30 13:12:57 IST 2025 (Tue Sep 30 07:42:57 UTC 2025)
...
set_log_file fv/pe64_standard/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/pe64_standard -revised fv_map
...
elaborate_design -golden -root {pe64_standard} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/pe64_standard/fv_map.v.gz
elaborate_design -revised -root {pe64_standard}
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/pe64_standard/rtl_to_fv_map.log
}
