...
# Generated on: Fri Oct 10 15:42:16 IST 2025 (Fri Oct 10 10:12:16 UTC 2025)
...
set_log_file fv/pe64_if_else/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/pe64_if_else -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  priority.v
elaborate_design -golden -root {pe64_if_else} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/pe64_if_else/fv_map.v.gz
elaborate_design -revised -root {pe64_if_else}
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/pe64_if_else/rtl_to_fv_map.log
}
