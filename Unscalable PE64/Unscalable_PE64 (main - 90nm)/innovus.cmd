...
#  Created on Wed Oct  8 14:44:37 2025                
#                                                     
#######################################################
...
timeDesign -preCTS -pathReports -drvReports -slackReports -numPaths 50 -prefix pe64_if_else_preCTS -outDir timingReports
report_area
report_power
setLayerPreference node_layer -isVisible 0
setLayerPreference node_layer -isVisible 1
...
setLayerPreference node_layer -isVisible 0
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postCTS -pathReports -drvReports -slackReports -numPaths 50 -prefix pe64_if_else_postCTS -outDir timingReports
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postCTS -pathReports -drvReports -slackReports -numPaths 50 -prefix pe64_if_else_postCTS -outDir timingReports
report_area
report_power
...
set_verify_drc_mode -disable_rules {} -check_ndr_spacing auto -check_only default -check_same_via_cell false -exclude_pg_net false -ignore_trial_route false -ignore_cell_blockage false -use_min_spacing_on_block_obs auto -report pe64_if_else.drc.rpt -limit 1000
verify_drc
set_verify_drc_mode -area {0 0 0 0}
verifyConnectivity -type all -error 1000 -warning 50
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postRoute -pathReports -drvReports -slackReports -numPaths 50 -prefix pe64_if_else_postRoute -outDir timingReports
...
timeDesign -postRoute -pathReports -drvReports -slackReports -numPaths 50 -prefix pe64_if_else_postRoute -outDir timingReports
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postRoute -hold -pathReports -slackReports -numPaths 50 -prefix pe64_if_else_postRoute -outDir timingReports
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postRoute -hold -pathReports -slackReports -numPaths 50 -prefix pe64_if_else_postRoute -outDir timingReports
report_area
report_power
...
ui_view_box
ui_view_box
dbquery -area {-25.4925 -2.0445 67.5425 42.9345} -objType inst
dbquery -area {-25.4925 -2.0445 67.5425 42.9345} -objType regular
dbquery -area {-25.4925 -2.0445 67.5425 42.9345} -objType special
verifyProcessAntenna -report pe64_if_else.antenna.rpt -error 1000
saveDesign pe64_if_else.enc
saveNetlist pe64_if_else_route.v
streamOut priority_64.gds -mapFile streamOut.map -libName DesignLib -units 2000 -mode ALL
win off
